...
public class C01AnnotationBased {
    ...
    @PostMapping("book")
    public Mono<ResponseEntity<?>> create(@Valid @RequestBody Book book, BindingResult bindingResult, UriComponentsBuilder ucb) throws MethodArgumentNotValidException {
        ...
        if (bindingResult.hasErrors()) {
            throw (
                    new MethodArgumentNotValidException(new MethodParameter(new Object() {
